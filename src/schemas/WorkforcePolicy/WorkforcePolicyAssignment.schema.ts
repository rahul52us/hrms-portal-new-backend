...
export interface WorkforcePolicyAssignmentI extends Document {
  ...
  resourceModel: "AttendancePolicy" | "WorkSchedule" | "HolidayCalendar" | "LeavePolicy" | "RemoteWorkPolicy";
...
const WorkforcePolicyAssignmentSchema = new Schema<WorkforcePolicyAssignmentI>(
  {
    ...
    resourceModel: {
      type: String,
      enum: ["AttendancePolicy", "WorkSchedule", "HolidayCalendar", "LeavePolicy", "RemoteWorkPolicy"],
      required: true,
    },
