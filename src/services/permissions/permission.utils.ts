...
export const PERMISSION_KEYS = {
  ...
  REOPEN_ATTENDANCE: "reopen_attendance",
  ...
  VIEW_REMOTE_WORK_REQUESTS: "view_remote_work_requests",
  APPROVE_REMOTE_WORK_REQUESTS: "approve_remote_work_requests",
  MANAGE_REMOTE_WORK_REQUESTS: "manage_remote_work_requests",
...
const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  {
    key: PERMISSION_KEYS.VIEW_LOCATIONS,
    label: "View Locations",
    description: "Open the office locations module.",
    category: "Navigation",
  },
  {
    key: PERMISSION_KEYS.MANAGE_LOCATIONS,
    label: "Manage Locations",
    description: "Create, update, deactivate, and delete office locations.",
    category: "Company",
  },
  {
    key: PERMISSION_KEYS.VIEW_WORKFORCE_POLICIES,
    label: "View Workforce Policies",
    description: "View effective-dated attendance, workweek, holiday, and assignment history.",
    category: "Workforce Policies",
  },
  {
    key: PERMISSION_KEYS.MANAGE_WORKFORCE_POLICIES,
    label: "Manage Workforce Policies",
    description: "Create, publish, assign, and archive workforce policy configurations.",
    category: "Workforce Policies",
  },
  {
    key: PERMISSION_KEYS.VIEW_ATTENDANCE,
    label: "View Attendance",
    description: "View organization attendance within the role's effective employee scope.",
    category: "Attendance",
  },
  {
    key: PERMISSION_KEYS.ADJUST_ATTENDANCE,
    label: "Adjust Attendance",
    description: "Create, correct, recalculate, and bulk-update attendance within employee scope.",
    category: "Attendance",
  },
  {
    key: PERMISSION_KEYS.FINALIZE_ATTENDANCE,
    label: "Finalize Attendance",
    description: "Finalize calculated attendance records and prevent further ordinary changes.",
    category: "Attendance",
  },
  {
    key: PERMISSION_KEYS.REOPEN_ATTENDANCE,
    label: "Reopen Attendance",
    description: "Reopen finalized attendance with a mandatory audited reason.",
    category: "Attendance",
  },
  {
    key: PERMISSION_KEYS.IMPORT_ATTENDANCE,
    label: "Import Attendance",
    description: "Preview and apply audited CSV or XLSX attendance imports.",
    category: "Attendance",
  },
  {
    key: PERMISSION_KEYS.APPROVE_ATTENDANCE_REGULARIZATIONS,
    label: "Approve Attendance Corrections",
    description: "Approve or reject attendance regularization requests within employee scope.",
    category: "Attendance",
  },
  {
    key: PERMISSION_KEYS.VIEW_LEAVE_REQUESTS,
    label: "View Leave Requests",
    description: "View leave requests and balances within the role's employee scope.",
    category: "Leave",
  },
  {
    key: PERMISSION_KEYS.APPROVE_LEAVE_REQUESTS,
    label: "Approve Leave Requests",
    description: "Approve or reject leave requests within the role's employee scope.",
    category: "Leave",
  },
  {
    key: PERMISSION_KEYS.MANAGE_LEAVE_BALANCES,
    label: "Manage Leave Balances",
    description: "Post audited opening balances and manual leave adjustments.",
    category: "Leave",
  },
  {
    key: PERMISSION_KEYS.VIEW_REMOTE_WORK_REQUESTS,
    label: "View Remote Work Requests",
    description: "View WFH requests within the role's employee scope.",
    category: "Remote Work",
  },
  {
    key: PERMISSION_KEYS.APPROVE_REMOTE_WORK_REQUESTS,
    label: "Approve Remote Work Requests",
    description: "Approve or reject WFH requests within the role's employee scope.",
    category: "Remote Work",
  },
  {
    key: PERMISSION_KEYS.MANAGE_REMOTE_WORK_REQUESTS,
    label: "Manage Remote Work Requests",
    description: "Cancel approved WFH requests and manage operational exceptions within scope.",
    category: "Remote Work",
  },
  {
...
const ADMIN_ALLOWED_PERMISSION_KEYS: PermissionKey[] = [
  ...
  PERMISSION_KEYS.MANAGE_LOCATIONS,
  PERMISSION_KEYS.VIEW_WORKFORCE_POLICIES,
  PERMISSION_KEYS.MANAGE_WORKFORCE_POLICIES,
  PERMISSION_KEYS.VIEW_ATTENDANCE,
  PERMISSION_KEYS.ADJUST_ATTENDANCE,
  PERMISSION_KEYS.FINALIZE_ATTENDANCE,
  PERMISSION_KEYS.REOPEN_ATTENDANCE,
  PERMISSION_KEYS.IMPORT_ATTENDANCE,
  PERMISSION_KEYS.APPROVE_ATTENDANCE_REGULARIZATIONS,
  PERMISSION_KEYS.VIEW_LEAVE_REQUESTS,
  PERMISSION_KEYS.APPROVE_LEAVE_REQUESTS,
  PERMISSION_KEYS.MANAGE_LEAVE_BALANCES,
  PERMISSION_KEYS.VIEW_REMOTE_WORK_REQUESTS,
...
const PERMISSION_DEPENDENCIES: Partial<Record<PermissionKey, PermissionKey[]>> = {
  ...
  [PERMISSION_KEYS.MANAGE_LOCATIONS]: [PERMISSION_KEYS.VIEW_LOCATIONS],
  [PERMISSION_KEYS.MANAGE_WORKFORCE_POLICIES]: [PERMISSION_KEYS.VIEW_WORKFORCE_POLICIES],
  [PERMISSION_KEYS.ADJUST_ATTENDANCE]: [PERMISSION_KEYS.VIEW_ATTENDANCE],
  [PERMISSION_KEYS.FINALIZE_ATTENDANCE]: [PERMISSION_KEYS.VIEW_ATTENDANCE],
  [PERMISSION_KEYS.REOPEN_ATTENDANCE]: [PERMISSION_KEYS.VIEW_ATTENDANCE],
  [PERMISSION_KEYS.IMPORT_ATTENDANCE]: [PERMISSION_KEYS.VIEW_ATTENDANCE],
  [PERMISSION_KEYS.APPROVE_ATTENDANCE_REGULARIZATIONS]: [PERMISSION_KEYS.VIEW_ATTENDANCE],
  [PERMISSION_KEYS.APPROVE_LEAVE_REQUESTS]: [PERMISSION_KEYS.VIEW_LEAVE_REQUESTS],
  [PERMISSION_KEYS.MANAGE_LEAVE_BALANCES]: [PERMISSION_KEYS.VIEW_LEAVE_REQUESTS],
  [PERMISSION_KEYS.APPROVE_REMOTE_WORK_REQUESTS]: [PERMISSION_KEYS.VIEW_REMOTE_WORK_REQUESTS],
  [PERMISSION_KEYS.MANAGE_REMOTE_WORK_REQUESTS]: [PERMISSION_KEYS.VIEW_REMOTE_WORK_REQUESTS],
